...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $user = DB::table('users')->select()->where("id = $id")->sql();
}
    ...
    <div class="container-fluid">
        <div class="mx-auto" style="margin-top: 50px;width: 100%;max-width: 800px;">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST" autocomplete="on">
                <input type="text" class="form-control" name="fullname" placeholder="FullName" value="محمد عاطف الفرحان"><br>
                <input type="text" class="form-control" name="username" placeholder="Username" value="Rambo"><br>
                <input type="password" class="form-control" name="password" placeholder="Password" value="Rambo"><br>
                <input type="email" class="form-control" name="email" placeholder="Email" value="rambo@yahoo.com"><br>
                <input type="tel" class="form-control" name="mobile" placeholder="mobile" value="0121313213"><br>
